...
export const Toast = ({
    ...
    return (
        <div className={cn(
            "p-3 relative rounded flex items-center gap-x-2 text-sm border",
            {"text-destructive border-destructive bg-destructive/15": type === "error"},
            {"text-emerald/900 border-emerald/900 bg-emerald/15": type === "success"},
            {"text-yellow border-yellow bg-yellow/15": type === "info"},
        )}>
